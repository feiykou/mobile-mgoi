    ...
    postcss: {
      plugins: {
        ...
        "postcss-px-to-viewport": { 
          ...
          selectorBlackList: ['body','html','.index-swiper-slide','.el-dialog__wrapper','.v-modal','.set-size','.font12', '.font14', '.font15', '.font16', '.font18', '.font20', '.font25', '.font24', '.font26', '.font34'], // 指定不转换为视窗单位的类，可以自定义，可以无限添加,建议定义一至两个通用的类名
